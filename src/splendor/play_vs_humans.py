...
# Moved verbatim to the engine package (phase-7) so lightweight consumers
# (the browser advisor) can render moves without importing this module's
# torch stack; the explicit re-exports keep every existing importer working.
from splendor.splendor.action_text import (  # noqa: F401  # re-export
    _card_cn,
    _gems_cn,
    describe_action,
)
